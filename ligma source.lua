                      ...
                      _class_4 = setmetatable({
                        __init = function(self, parent, flag, options)
                          ...
                          mouse_button_click = function()
                            ...
                            self.window.drop_container.Position = UDim2.new(0, self.button.AbsolutePosition.X / s, 0, (self.button.AbsolutePosition.Y + self.button.AbsoluteSize.Y) / s)
                        ...
                        _class_5 = setmetatable({
                          __init = function(self, parent, flag, options)
                            ...
                            mouse_button_right_click = function()
                              ...
                              local s = self.window.scale and self.window.scale.Scale or 1
                              self.window.keybind_objects[1].Position = UDim2.new(0, (keybind.AbsolutePosition.X + keybind.AbsoluteSize.X) / s, 0, keybind.AbsolutePosition.Y / s)
                            end
                            mouse_button_click = function()
                              self.window.current_keybind = flag
      ...
      __init = function(self, title, position, size)
        ...
        mouse_moved = function(input)
          if self.dragging then
            ...
            self.position = self.position + UDim2.new(0, (input.Position.X - self.drag_start.X) / s, 0, (input.Position.Y - self.drag_start.Y) / s)
            self.drag_start = input.Position
            return self:update()
          end
        end
